...
TITLE rules (under 70 characters, natural language sentence-fragment):
...
DESCRIPTION rules (1000+ characters, plain text, no markdown):
- The first 40 characters MUST contain the primary product keyword
- The first 160 characters are critical (Google preview + Etsy "Read more" cutoff): make them a natural hook stating WHAT it is, WHO it suits, WHY it stands out — not "Welcome to my shop..."
- Structure (paragraphs separated by blank lines):
  1) Hook paragraph (2-3 sentences): product + audience + why special, keywords woven naturally
  2) DETAILS section: bullet-style facts on a separate line each — size, material, weight, color options, personalization steps if any
  3) CARE / USAGE: washing/handling instructions if applicable
  4) SHIPPING: when it ships, how it's packaged
  5) CTA: "Favorite this listing to grab it later" or "Visit the shop for more designs" — short, friendly
- Friendly, natural English; no robotic enumerations
${wantTags ? `
